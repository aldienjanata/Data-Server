...
export function getDeviceIcon(typeName) {
  const svgs = {
    'OTB': '<img src="/logos/OTB.webp" style="width:28px;height:28px;object-fit:contain;">',
    'CISCO': '<img src="/logos/CISCO.webp" style="width:28px;height:28px;object-fit:contain;">',
    'HUAWEI': '<img src="/logos/Huawei.webp" style="width:28px;height:28px;object-fit:contain;">',
    'GTGO': '<img src="/logos/GTGO OLT.jpeg" style="width:28px;height:28px;object-fit:contain;border-radius:4px;">',
